 ...
 */
     ...
     */ 
         ...
         * @static 
         */ 
        public static function apiSuccess($data, $message = [], $code = 200)
        {
                        return \Illuminate\Routing\ResponseFactory::apiSuccess($data, $message, $code);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function apiError($errors, $message = [], $code = 400)
        {
                        return \Illuminate\Routing\ResponseFactory::apiError($errors, $message, $code);
        }
